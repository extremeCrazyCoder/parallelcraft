 ...
 */
public class PacketPlayInDifficultyChange extends PacketIncoming {
    ...
    public void decode(PacketReadHelper data) throws InsufficientDataException {
        this.difficulty = data.readEnumAsByte(EnumDifficulty.class);
    }
    ...
    public String toString() {
        return "PacketPlayInDifficultyChange["
