...
import com.parallelcraft.Networking.Packets.PacketHandshakingInSetProtocol;
import com.parallelcraft.Networking.Packets.PacketLoginInEncryptionBegin;
import com.parallelcraft.Networking.Packets.PacketLoginInStart;
import com.parallelcraft.Networking.Packets.PacketLoginOutEncryptionBegin;
import com.parallelcraft.Networking.Packets.PacketLoginOutSuccess;
import com.parallelcraft.exceptions.ProtocolException;
...
public class HandshakePacketHandler implements PacketHandler {
    ...
    public void handle(PacketIncoming p) {
        if(p instanceof PacketHandshakingInSetProtocol) {
            ...
            //TODO use mojangs authlib with authNonce
